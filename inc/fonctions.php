<?php
    ...
    function get_all_total_depense_par_rattachement(){
        $sql= "SELECT * FROM loi_financier_total_depense_rattachement ";
    ...
    function get_somme_rattachement(){
        $sql="SELECT SUM(total_2024) as st24, SUM(total_2025) as st25 FROM loi_financier_total_depense_rattachement";
        $resultat=mysqli_query(dbconnect(),$sql);
    ...
    function get_all_depense_ministere(){
        $sql= "SELECT * FROM v_depense_ministere";
    ...
    function get_total_depense_ministere(){
        $sql="SELECT SUM(somme_2024) as total_2024, SUM(somme_2025) as total_2025 FROM v_depense_ministere";
        $resultat=mysqli_query(dbconnect(),$sql);
